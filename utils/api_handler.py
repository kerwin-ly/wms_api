...
def register_api_handler(app: Flask) -> None:
    ...
    def err_not_catch() -> typing.Tuple[Response, typing.Optional[int]]:
        ...
        session.rollback()
        return ApiResponse.fail("服务器内部错误或网络错误", 500)
